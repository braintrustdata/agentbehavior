...
Agents that discover repository skills can use [`.agents/skills/writing-agent-behavior`](https://github.com/braintrustdata/agentbehavior/tree/main/.agents/skills/writing-agent-behavior) directly in this repository. To use it in another project, copy that entire directory to `<project>/.agents/skills/writing-agent-behavior/`. The directory includes a portable format summary and has no runtime dependency on this source checkout.
